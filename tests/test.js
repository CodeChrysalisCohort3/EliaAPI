...
describe('users', () => {
  ...
  describe('#create', () => {
    ...
    context('when bad params are given', () => {
      ...
      it('politely refuses', () => db.users.create(params)
        ...
        .catch(err => expect(err.message).to.equal('Username must be provided, and be at least two characters')));
    });
    ...
    context('when good params are given', () => {
      ...
      context('when a duplicate username is provided', () => {
        ...
        it('generates a sanitized error message', () => db.users.create(params)
          .then(forcePromiseReject)
          .catch(err => expect(err.message).to.equal('That username already exists')));
      });
    });
  });
  ...
  describe('#list', () => {
    ...
    before(() => Promise.all(users.map(user => db.users.create(user))));
  ...
  describe('#create', () => {
    ...
    context('when a duplicate name is provided', () => {
      ...
      it('generates a sanitized error message', () => db.channels.create(params)
        .then(forcePromiseReject)
        .catch(err => expect(err.message).to.equal('That channel already exists')));
    });
  });
